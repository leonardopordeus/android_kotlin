...
var routes = [
    ...
    { path: 'node-list', loadChildren: './pages/node-list/node-list.module#NodeListPageModule' },
];
...
module.exports = __webpack_require__(/*! D:\Aulas\android2\Ionic\ceiotApp\src\main.ts */"./src/main.ts");
